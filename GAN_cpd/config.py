...
desc += '-preset-v2-8gpus'; num_gpus = 8; sched.minibatch_base = 64; sched.lod_initial_resolution = 256; sched.minibatch_dict = {256:160,512:64}; sched.G_lrate_base=0.005; sched.D_lrate_base=0.005; train.total_kimg = 14000; train.compute_fid_score = True; train.minimum_fid_kimg = 6000; train.fid_snapshot_ticks = 4; train.fid_patience=2; train.result_subdir = "./"; train.resume_run_id="./"; train.resume_kimg=4000;

# Numerical precision (choose one).
desc += '-fp32'; sched.max_minibatch_per_gpu = {256: 32, 512: 32}
